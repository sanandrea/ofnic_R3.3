...
public:
    ...
    */
     hash_map<datapathid,DpInfo> get_whole_topology();



    /**UoR
    */
     std::list<NodeInfo> get_node_list() ;


    /**UoR
    */
     std::list<PortInfo> get_port_list(datapathid dp) ;


    /**UoR
    */
     PortInfo get_port_info(datapathid id, std::string pname) ;

   /** UoR
   */
    
    bool is_valid_datapath(datapathid dp);

    bool is_valid_port(datapathid dpid, std::string portName);
